(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : ((global = typeof globalThis !== "undefined" ? globalThis : global || self),
      (global.datav = factory(global.Vue)));
})(this, function (Vue) {
  "use strict";
  ...
  const _hoisted_2$z = /*#__PURE__*/ Vue.createStaticVNode(
  ...
  function render$A(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      Vue.createElementBlock("div", _hoisted_1$z, [
        _hoisted_2$z,
        Vue.createElementVNode("div", _hoisted_3$x, [Vue.renderSlot(_ctx.$slots, "default")]),
      ])
    );
  }
  ...
  var util = createCommonjsModule(function (module, exports) {
    ...
    function getLinearGradientColor(ctx, begin, end, color) {
      ...
      var linearGradientColor = ctx.createLinearGradient.apply(
        ctx,
        (0, _toConsumableArray2["default"])(begin).concat((0, _toConsumableArray2["default"])(end))
      );
    ...
    return (
            ...
            [
              Vue.createElementVNode(
                "polygon",
                {
                  ...
                  points: `10, 27 10, ${_ctx.height - 27} 13, ${_ctx.height - 24} 13, ${_ctx.height - 21} 24, ${
                    _ctx.height - 11
                  }
      38, ${_ctx.height - 11} 41, ${_ctx.height - 8} 73, ${_ctx.height - 8} 75, ${_ctx.height - 10} 81, ${
                    _ctx.height - 10
                  }
      85, ${_ctx.height - 6} ${_ctx.width - 85}, ${_ctx.height - 6} ${_ctx.width - 81}, ${_ctx.height - 10} ${
                    _ctx.width - 75
                  }, ${_ctx.height - 10}
      ${_ctx.width - 73}, ${_ctx.height - 8} ${_ctx.width - 41}, ${_ctx.height - 8} ${_ctx.width - 38}, ${
                    _ctx.height - 11
                  }
      ${_ctx.width - 24}, ${_ctx.height - 11} ${_ctx.width - 13}, ${_ctx.height - 21} ${_ctx.width - 13}, ${
                    _ctx.height - 24
                  }
      ...
      ${_ctx.width - 81}, 10 ${_ctx.width - 85}, 6 85, 6 81, 10 75, 10 73, 8 41, 8 38, 11 24, 11 13, 21 13, 24`,
          ...
          Vue.createElementBlock(
            Vue.Fragment,
            null,
            Vue.renderList($data.border, (item) => {
              return (
                Vue.openBlock(),
                Vue.createElementBlock(
                  "svg",
          ...
          Vue.createElementVNode("div", _hoisted_9$g, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
  ...
  function render$y(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      `,
          ...
          Vue.createElementVNode("div", _hoisted_9$f, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
      ...
      `,
              ...
              Vue.createElementVNode(
                "polyline",
                {
                  class: "dv-bb3-line1",
                  stroke: $data.mergedColor[0],
                  points: `4, 4 ${_ctx.width - 22} ,4 ${_ctx.width - 22}, ${_ctx.height - 22} 4, ${
                    _ctx.height - 22
                  } 4, 4`,
                },
                null,
              ...
              Vue.createElementVNode(
                "polyline",
                {
                  class: "dv-bb3-line2",
                  stroke: $data.mergedColor[1],
                  points: `10, 10 ${_ctx.width - 16}, 10 ${_ctx.width - 16}, ${_ctx.height - 16} 10, ${
                    _ctx.height - 16
                  } 10, 10`,
                },
                null,
              ...
              Vue.createElementVNode(
                "polyline",
                {
                  class: "dv-bb3-line2",
                  stroke: $data.mergedColor[1],
                  points: `16, 16 ${_ctx.width - 10}, 16 ${_ctx.width - 10}, ${_ctx.height - 10} 16, ${
                    _ctx.height - 10
                  } 16, 16`,
                },
                null,
              ...
              Vue.createElementVNode(
                "polyline",
                {
                  class: "dv-bb3-line2",
                  stroke: $data.mergedColor[1],
                  points: `22, 22 ${_ctx.width - 4}, 22 ${_ctx.width - 4}, ${_ctx.height - 4} 22, ${
                    _ctx.height - 4
                  } 22, 22`,
                },
                null,
          ...
          Vue.createElementVNode("div", _hoisted_7$k, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
  ...
  function render$w(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      `,
          ...
          Vue.createElementVNode("div", _hoisted_13$9, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
            ...
            [
              Vue.createElementVNode(
                "polygon",
                {
                  fill: $props.backgroundColor,
                  points: `
        10, 22 ${_ctx.width - 22}, 22 ${_ctx.width - 22}, ${_ctx.height - 86} ${_ctx.width - 84}, ${
                    _ctx.height - 24
                  } 10, ${_ctx.height - 24}
      `,
                },
          ...
          Vue.createElementVNode("div", _hoisted_9$d, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
  ...
  function render$u(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      `,
          ...
          Vue.createElementVNode("div", _hoisted_19$5, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
      ...
      Vue.createElementBlock(
        "div",
        {
          ...
          style: Vue.normalizeStyle(
            `box-shadow: inset 0 0 40px ${$data.mergedColor[0]}; border: 1px solid ${$data.mergedColor[0]}; background-color: ${$props.backgroundColor}`
          ),
          ref: $data.ref,
        },
        [
            ...
            [
              ...
              Vue.createElementVNode(
                "polyline",
                {
                  class: "dv-bb7-line-width-2",
                  stroke: $data.mergedColor[0],
                  points: `${_ctx.width - 25}, ${_ctx.height} ${_ctx.width}, ${_ctx.height} ${_ctx.width}, ${
                    _ctx.height - 25
                  }`,
                },
                null,
              ...
              Vue.createElementVNode(
                "polyline",
                {
                  class: "dv-bb7-line-width-5",
                  stroke: $data.mergedColor[1],
                  points: `${_ctx.width - 10}, ${_ctx.height} ${_ctx.width}, ${_ctx.height} ${_ctx.width}, ${
                    _ctx.height - 10
                  }`,
                },
                null,
          ...
          Vue.createElementVNode("div", _hoisted_10$a, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        4 /* STYLE */
      )
    );
  ...
  const _hoisted_4$m = /*#__PURE__*/ Vue.createElementVNode(
    "stop",
    {
      offset: "0%",
      "stop-color": "#fff",
  ...
  const _hoisted_5$j = /*#__PURE__*/ Vue.createElementVNode(
    "stop",
    {
      offset: "100%",
      "stop-color": "#fff",
    ...
    return (
      ...
      Vue.createElementBlock(
        ...
        [
          ...
          Vue.createElementVNode("div", _hoisted_14$7, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
  ...
  const _hoisted_4$l = /*#__PURE__*/ Vue.createElementVNode(
    "animate",
    {
      attributeName: "x2",
      values: "100%;0%;100%",
  ...
  function render$r(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      Vue.createElementBlock(
            ...
            `,
                    ...
                    Vue.createElementVNode(
                      "polyline",
                      {
                        ...
                        "stroke-width": "3",
                        fill: "transparent",
                        points: `8, ${_ctx.height * 0.5} 8, ${_ctx.height - 3} ${_ctx.width * 0.3 + 7}, ${
                          _ctx.height - 3
                        }`,
                      },
                      null,
            ...
            `,
                    ...
                    Vue.createElementVNode(
                      "polyline",
                      {
                        ...
                        "stroke-width": "3",
                        fill: "transparent",
                        points: `${_ctx.width * 0.35}, ${_ctx.height - 3} ${_ctx.width - 3}, ${_ctx.height - 3} ${
                          _ctx.width - 3
                        }, ${_ctx.height * 0.35}`,
                      },
                      null,
                    ...
                    Vue.createElementVNode(
                      "polyline",
                      {
                        fill: "#fff",
                        points: `
              ${_ctx.width * 0.92}, ${_ctx.height - 3} ${_ctx.width - 3}, ${_ctx.height - 3} ${_ctx.width - 3}, ${
                          _ctx.height * 0.8
                        }
              ${_ctx.width - 9}, ${_ctx.height * 0.8 + 7} ${_ctx.width - 9}, ${_ctx.height - 9} ${
                          _ctx.width * 0.92 + 7
                        }, ${_ctx.height - 9}
            `,
                      },
        ...
        ${_ctx.width * 0.9 + 2}, 6 ${_ctx.width * 0.9 + 6}, 10 ${_ctx.width - 10}, 10 ${_ctx.width - 10}, ${
                    _ctx.height * 0.1 - 6
                  }
        ${_ctx.width - 6}, ${_ctx.height * 0.1 - 1} ${_ctx.width - 6}, ${_ctx.height * 0.8 + 1} ${_ctx.width - 10}, ${
                    _ctx.height * 0.8 + 6
                  }
        ${_ctx.width - 10}, ${_ctx.height - 10} ${_ctx.width * 0.92 + 7}, ${_ctx.height - 10}  ${
                    _ctx.width * 0.92 + 2
                  }, ${_ctx.height - 6}
      ...
      `,
          ...
          Vue.createElementVNode("div", _hoisted_21$4, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
  ...
  function render$q(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      `,
          ...
          Vue.createElementVNode("div", _hoisted_4$k, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        4 /* STYLE */
      )
    );
  ...
  function y(r) {
    if (i(r)) return r;
    const t = a(r),
      e = (n) => Number(n).toString(16).padStart(2, "0");
    return `#${t.map(e).join("")}`;
  }
  function u(r) {
  ...
  const _hoisted_6$e = /*#__PURE__*/ Vue.createElementVNode(
    "feComposite",
    {
      in: "glowColor",
      in2: "blurred",
  ...
  const _hoisted_7$d = /*#__PURE__*/ Vue.createElementVNode(
    "feMerge",
    null,
    [
  ...
  const _hoisted_14$5 = /*#__PURE__*/ Vue.createElementVNode(
    "animate",
    {
  ...
  const _hoisted_17$4 = /*#__PURE__*/ Vue.createElementVNode(
    "animate",
    {
      attributeName: "opacity",
      values: "0.7;0.4;0.7",
  ...
  const _hoisted_20$3 = /*#__PURE__*/ Vue.createElementVNode(
    "animate",
    {
      attributeName: "opacity",
      values: "0.5;0.2;0.5",
  ...
  const _hoisted_23$2 = /*#__PURE__*/ Vue.createElementVNode(
    "animate",
    {
      attributeName: "opacity",
      values: "1;0.7;1",
  ...
  const _hoisted_29 = /*#__PURE__*/ Vue.createElementVNode(
    "animate",
    {
      attributeName: "opacity",
      values: "0.5;0.2;0.5",
  ...
  function render$p(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      Vue.createElementBlock(
        ...
        ${_ctx.width - 20}, 32 ${_ctx.width - 8}, 48 ${_ctx.width - 8}, ${_ctx.height - 25} ${_ctx.width - 20}, ${
                    _ctx.height - 8
                  }
      ...
      `,
        ...
        `,
          ...
          Vue.createElementVNode("div", _hoisted_34, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
  ...
  const _hoisted_4$i = /*#__PURE__*/ Vue.createElementVNode(
    "feGaussianBlur",
    {
      in: "thicken",
      stdDeviation: "2",
  ...
  const _hoisted_7$c = /*#__PURE__*/ Vue.createElementVNode(
    "feComposite",
    {
      in: "glowColor",
      in2: "blurred",
  ...
  const _hoisted_8$8 = /*#__PURE__*/ Vue.createElementVNode(
    "feMerge",
    null,
    [
      /*#__PURE__*/ Vue.createElementVNode("feMergeNode", {
    ...
    return (
      ...
      Vue.createElementBlock(
        ...
        [
          ...
          L ${_ctx.width - 5} ${_ctx.height - 15} Q ${_ctx.width - 5} ${_ctx.height - 5}, ${_ctx.width - 15} ${
                        _ctx.height - 5
                      }
        ...
        `,
              ...
              Vue.createElementVNode(
                "path",
                {
                  ...
                  filter: `url(#${$data.filterId})`,
                  stroke: $data.mergedColor[1],
                  d: `M ${_ctx.width - 20} 5 L ${_ctx.width - 15} 5 Q ${_ctx.width - 5} 5 ${_ctx.width - 5} 15 L ${
                    _ctx.width - 5
                  } 20`,
                },
                null,
        ...
        `,
          ...
          Vue.createElementVNode("div", _hoisted_14$4, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
        ...
        `,
              ...
              Vue.createElementVNode(
                "path",
                {
                  fill: "transparent",
                  stroke: $data.mergedColor[1],
                  d: `M ${_ctx.width - 5} ${_ctx.height - 30} L ${_ctx.width - 5} ${_ctx.height - 5} L ${
                    _ctx.width - 30
                  } ${_ctx.height - 5}`,
                },
                null,
          ...
          Vue.createElementVNode("div", _hoisted_6$c, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
  ...
  const _hoisted_10$5 = /*#__PURE__*/ Vue.createElementVNode(
    "animate",
    {
      attributeName: "width",
      values: "0;40;0",
          ...
          Vue.createElementBlock(
            ...
            [
              ...
              Vue.createElementBlock(
                Vue.Fragment,
                null,
                Vue.renderList($data.points, (point, i) => {
                  return (
                    Vue.openBlock(),
                    Vue.createElementBlock(
                      Vue.Fragment,
        ...
        [
          Vue.createElementVNode(
            "div",
            {
              ...
              style: Vue.normalizeStyle(
                $props.reverse
                  ? `width:${_ctx.width}px;height:5px;animation-duration:${$props.dur}s`
                  : `width:5px;height:${_ctx.height}px;animation-duration:${$props.dur}s`
              ),
            },
            [
              (Vue.openBlock(),
                    ...
                    Vue.createElementBlock(
                      ...
                      [
                        Vue.createElementVNode(
                          ...
                          {
                            attributeName: "y",
                            values: `${point[1] - $data.minHeights[i] / 2};${point[1] - $data.heights[i] / 2};${
                              point[1] - $data.minHeights[i] / 2
                            }`,
  ...
  function render$g(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      Vue.createElementBlock("div", _hoisted_1$f, [
        (Vue.openBlock(),
        Vue.createElementBlock("svg", _hoisted_2$f, [
          Vue.createElementVNode(
            "polyline",
            {
              "stroke-width": "4",
        ...
        Vue.renderSlot(_ctx.$slots, "default"),
        (Vue.openBlock(),
        Vue.createElementBlock("svg", _hoisted_5$b, [
          Vue.createElementVNode(
            "polyline",
            {
              "stroke-width": "4",
            ...
            [
              ...
              Vue.createElementVNode(
                "polyline",
                {
                  ...
                  "stroke-width": "2",
                  fill: "transparent",
                  points: `${$options.xPos(20)}, 0 ${$options.xPos(50)}, ${_ctx.height / 2} ${$options.xPos(
                    _ctx.width
                  )}, ${_ctx.height / 2}`,
                },
                null,
          ...
          Vue.createElementBlock(
            ...
            [
              ...
              Vue.createElementBlock(
                Vue.Fragment,
                null,
                Vue.renderList(new Array(20).fill(0), (foo, i) => {
                  return (
                    Vue.openBlock(),
                    Vue.createElementBlock(
                      "use",
            ...
            [
              ...
              Vue.createElementVNode(
                "polygon",
                {
                  fill: $options.fade($data.mergedColor[1] || $data.defaultColor[1], 10),
                  stroke: $data.mergedColor[1],
                  points: `${_ctx.width - 20} ${_ctx.height - 10}, ${_ctx.width - 25} ${_ctx.height - 4}, ${
                    _ctx.width - 55
                  } ${_ctx.height - 4} ${_ctx.width - 60} ${_ctx.height - 10}`,
                },
                null,
                8 /* PROPS */,
                _hoisted_5$8
        ...
        `,
              ...
              Vue.createElementVNode(
                "polyline",
                {
                  fill: "transparent",
                  stroke: $options.fade($data.mergedColor[0] || $data.defaultColor[0], 70),
                  points: `${_ctx.width - 25} 18, ${_ctx.width - 15} ${_ctx.height / 2} ${_ctx.width - 25} ${
                    _ctx.height - 18
                  }`,
                },
                null,
          ...
          Vue.createElementVNode("div", _hoisted_9$3, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
        ...
        [
          ...
          Vue.createElementBlock(
            ...
            [
              ...
              $data.showSplitLine
                ? (Vue.openBlock(),
                  Vue.createElementBlock("g", _hoisted_12$2, [
                    (Vue.openBlock(true),
                    Vue.createElementBlock(
                      Vue.Fragment,
                      null,
                      Vue.renderList($data.splitLinePoints, (p) => {
                        return (
                          Vue.openBlock(),
                          Vue.createElementBlock(
                            "polyline",
          ...
          Vue.createElementVNode("div", _hoisted_17$2, [Vue.renderSlot(_ctx.$slots, "default")]),
        ],
        512 /* NEED_PATCH */
      )
    );
  ...
  var polylineToBezierCurve_1 = createCommonjsModule(function (module, exports) {
    ...
    function polylineToBezierCurve(polyline) {
      ...
      var bezierCurvePoints = new Array(bezierCurveLineNum).fill(0).map(function (foo, i) {
        return [].concat(
          (0, _toConsumableArray2["default"])(getBezierCurveLineControlPoints(polyline, i, close, offsetA, offsetB)),
          [polyline[i + 1]]
        );
      });
  ...
  var graphs_1 = createCommonjsModule(function (module, exports) {
    ...
    var ellipse = {
      ...
      hoverCheck: function hoverCheck(position, _ref11) {
        ...
        var distance =
          (0, util$1.getTwoPointDistance)(position, leftFocusPoint) +
          (0, util$1.getTwoPointDistance)(position, rightFocusPoint);
        return distance <= 2 * a;
      },
    ...
    var arc = {
      ...
      hoverCheck: function hoverCheck(position, _ref32) {
        ...
        return (
          !(0, util$1.checkPointIsInSector)(position, rx, ry, insideRadius, startAngle, endAngle, clockWise) &&
          (0, util$1.checkPointIsInSector)(position, rx, ry, outsideRadius, startAngle, endAngle, clockWise)
        );
      },
  ...
  var style_class = createCommonjsModule(function (module, exports) {
    ...
    function initGradient(ctx, style) {
      ...
      var gradient = ctx[
        "create".concat(gradientType.slice(0, 1).toUpperCase() + gradientType.slice(1), "Gradient")
    ...
    function gradientValidator(style) {
      ...
      if (gradientStops !== "auto" && !(gradientStops instanceof Array)) {
        console.warn(
          "gradientStops only supports 'auto' or Number Array ([0, .5, 1]), current value is " + gradientStops
        );
        return false;
      }
  ...
  var graph_class = createCommonjsModule(function (module, exports) {
    ...
    Graph.prototype.hoverCheckProcessor = function (position, _ref) {
      ...
      if (graphCenter) {
        ...
        if (scale)
          position = (0, util$1.getScalePointPos)(
        ...
        if (translate)
          position = (0, util$1.getTranslatePointPos)(
      ...
      if (hoverRect)
        return util$1.checkPointIsInRect.apply(
          void 0,
  ...
  var pie_1 = createCommonjsModule(function (module, exports) {
    ...
    function calcPiesPercent(pies) {
      pies.forEach(function (pie) {
        ...
        var percentSumNoLast = (0, util.mulAdd)(
    ...
    function getPieInsideLabelPos(pieItem, dataItem) {
      ...
      return util$1.getCircleRadianPoint.apply(
        void 0,
    ...
    function calcPiesEdgeCenterPos(pies) {
      pies.forEach(function (pie) {
        ...
        data.forEach(function (item) {
          ...
          var pos = util$1.getCircleRadianPoint.apply(
            void 0,
            (0, _toConsumableArray2["default"])(center).concat([radius[1], centerAngle])
          );
    ...
    function addLabelLineAndAlign(dataItem, pieItem) {
      ...
      dataItem.forEach(function (item) {
        ...
        var bendPoint = util$1.getCircleRadianPoint.apply(
          void 0,
          (0, _toConsumableArray2["default"])(center).concat([radius, angle])
        );
  ...
  var radarAxis_1 = createCommonjsModule(function (module, exports) {
    ...
    function getSplitAreaStyle(radarAxis, i) {
      ...
      if (polygon) {
        var point1 = util$1.getCircleRadianPoint.apply(
          void 0,
          (0, _toConsumableArray2["default"])(centerPos).concat([ringRadius[0], axisLineAngles[0]])
        );

        var point2 = util$1.getCircleRadianPoint.apply(
          void 0,
          (0, _toConsumableArray2["default"])(centerPos).concat([ringRadius[0], axisLineAngles[1]])
        );
    ...
    function calcRadarPosition(radars, chart) {
      ...
      radars.forEach(function (radarItem) {
        ...
        radarItem.radarPosition = indicator.map(function (_ref, i) {
          ...
          return util$1.getCircleRadianPoint.apply(
            void 0,
            (0, _toConsumableArray2["default"])(centerPos).concat([dataRadius, axisLineAngles[i]])
          );
        });
      });
      return radars;
    ...
    function calcRadarLabelPosition(radars, chart) {
      ...
      radars.forEach(function (radarItem) {
        ...
        radarItem.labelPosition = dataRadius.map(function (r, i) {
          return util$1.getCircleRadianPoint.apply(
            void 0,
            (0, _toConsumableArray2["default"])(centerPos).concat([r + labelGap, axisLineAngles[i]])
          );
        });
      });
      return radars;
    ...
    function calcGaugesAxisTickPosition(gauges, chart) {
      gauges.forEach(function (gaugeItem) {
        ...
        gaugeItem.tickPosition = new Array(splitNum).fill(0).map(function (foo, i) {
          ...
          return [
            util$1.getCircleRadianPoint.apply(
              void 0,
              (0, _toConsumableArray2["default"])(center).concat([outerRadius, angle])
            ),
            util$1.getCircleRadianPoint.apply(
              void 0,
              (0, _toConsumableArray2["default"])(center).concat([innerRadius, angle])
            ),
          ];
        });
      });
    ...
    function calcGaugesLabelPositionAndAlign(gauges, chart) {
      gauges.forEach(function (gaugeItem) {
        ...
        var position = tickAngles.map(function (angle, i) {
          return util$1.getCircleRadianPoint.apply(
            void 0,
            (0, _toConsumableArray2["default"])(center).concat([tickInnerRadius[i] - labelGap, tickAngles[i]])
          );
        });
      ...
      gauges.forEach(function (gaugeItem) {
        ...
        var detailsPosition = data.map(function (_ref3) {
          ...
          if (position === "center") {
            ...
            point = util$1.getCircleRadianPoint.apply(
              void 0,
              (0, _toConsumableArray2["default"])(center).concat([radius, startAngle])
            );
  ...
  function render$9(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      Vue.openBlock(),
      Vue.createElementBlock("div", _hoisted_1$9, [
        Vue.createElementVNode("canvas", _hoisted_2$9, null, 512 /* NEED_PATCH */),
      ])
    );
  }
  ...
  function render$8(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (
      ...
      Vue.createElementBlock("div", _hoisted_1$8, [
        Vue.createElementVNode("div", _hoisted_2$8, null, 512 /* NEED_PATCH */),
        Vue.createElementVNode("div", _hoisted_3$7, [
          Vue.createVNode(
            _component_dv_digital_flop,
            {
          ...
          Vue.createElementVNode(
            ...
            Vue.toDisplayString($options.ringName),
            5 /* TEXT, STYLE */
          ),
        ]),
      ])
              ...
              [
                Vue.createElementVNode("div", _hoisted_2$7, [
                  ...
                  Vue.createElementBlock(
                    Vue.Fragment,
                    null,
                    Vue.renderList($data.mergedConfig.data, (item) => {
                      return (
                        Vue.openBlock(),
                        Vue.createElementBlock(
                          "div",
                ...
                Vue.createElementVNode("div", _hoisted_4$6, [
                  ...
                  Vue.createElementBlock(
                    Vue.Fragment,
                    null,
                    Vue.renderList($data.capsuleLength, (capsule, index) => {
                      return (
                        Vue.openBlock(),
                        Vue.createElementBlock(
                          "div",
                              ...
                              "div",
                              {
                                ...
                                style: Vue.normalizeStyle(
                                  `width: ${capsule * 100}%; background-color: ${
                                    $data.mergedConfig.colors[index % $data.mergedConfig.colors.length]
                                  };`
                                ),
                              },
                              [
                                $data.mergedConfig.showValue
                                  ? (Vue.openBlock(),
                                    Vue.createElementBlock(
                                      "div",
                                      _hoisted_5$6,
                                      Vue.toDisplayString($data.capsuleValue[index]),
                                      1 /* TEXT */
                                    ))
                                  : Vue.createCommentVNode("v-if", true),
                              ],
                  ...
                  Vue.createElementVNode("div", _hoisted_6$5, [
                    ...
                    Vue.createElementBlock(
                      Vue.Fragment,
                      null,
                      Vue.renderList($data.labelData, (label, index) => {
                        return (
                          Vue.openBlock(),
                          Vue.createElementBlock(
                            "div",
                ...
                $data.mergedConfig.unit
                  ? (Vue.openBlock(),
                    Vue.createElementBlock(
                      "div",
                      _hoisted_7$5,
                      Vue.toDisplayString($data.mergedConfig.unit),
                      1 /* TEXT */
                    ))
                  : Vue.createCommentVNode("v-if", true),
              ],
  ...
  function render$6(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      Vue.createElementBlock("div", _hoisted_1$6, [
        $data.renderer
          ? (Vue.openBlock(),
            Vue.createElementBlock("svg", _hoisted_2$6, [
              Vue.createElementVNode("defs", null, [
                Vue.createElementVNode(
                  "linearGradient",
                  {
                  ...
                  [
                    ...
                    Vue.createElementBlock(
                      Vue.Fragment,
                      null,
                      Vue.renderList($data.svgBorderGradient, (lc) => {
                        return (
                          Vue.openBlock(),
                          Vue.createElementBlock(
                            "stop",
              ...
              Vue.createElementVNode(
                ...
                Vue.toDisplayString($data.details),
                9 /* TEXT, PROPS */,
                _hoisted_5$5
              ),
              !$options.shape || $options.shape === "round"
                ? (Vue.openBlock(),
                  Vue.createElementBlock(
                    "ellipse",
                    {
  ...
  function render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      Vue.createElementBlock(
        ...
        [
          (Vue.openBlock(),
          Vue.createElementBlock("svg", null, [
            Vue.createElementVNode("defs", null, [
              Vue.createElementVNode(
                "linearGradient",
                {
                ...
                [
                  ...
                  Vue.createElementBlock(
                    Vue.Fragment,
                    null,
                    Vue.renderList($options.linearGradient, (lc) => {
                      return (
                        Vue.openBlock(),
                        Vue.createElementBlock(
                          "stop",
            ...
            Vue.createElementVNode(
              ...
              Vue.toDisplayString($options.details),
              9 /* TEXT, PROPS */,
              _hoisted_8$2
            ),
          ])),
    ...
    return (
      ...
      Vue.createElementBlock(
        "div",
        {
          ...
          onClick:
            _cache[0] || (_cache[0] = (...args) => $options.consoleClickPos && $options.consoleClickPos(...args)),
        },
        [
          $data.mergedConfig
            ? (Vue.openBlock(),
              Vue.createElementBlock(
                ...
                [
                  ...
                  $data.paths[0] && $data.mergedConfig.halo.show
                    ? (Vue.openBlock(),
                      Vue.createElementBlock(
                        "use",
                        {
                  ...
                  Vue.createElementBlock(
                    Vue.Fragment,
                    null,
                    Vue.renderList($data.paths, (path, i) => {
                      return (
                        Vue.openBlock(),
                        Vue.createElementBlock(
                          "g",
                          ...
                          [
                            ...
                            Vue.createElementVNode(
                              ...
                              Vue.toDisplayString($data.texts[i]),
                              13 /* TEXT, STYLE, PROPS */,
                              _hoisted_25
                            ),
                          ]
            ...
            ? (Vue.openBlock(),
              Vue.createElementBlock(
                ...
                [
                  ...
                  Vue.createCommentVNode(" points "),
                  (Vue.openBlock(true),
                  Vue.createElementBlock(
                    Vue.Fragment,
                    null,
                    Vue.renderList($data.flylinePoints, (point) => {
                      return (
                        Vue.openBlock(),
                        Vue.createElementBlock(
                          "g",
                          ...
                          [
                            ...
                            Vue.createCommentVNode(" halo gradient mask "),
                            Vue.createElementVNode(
                              "mask",
                              {
                            ...
                            Vue.createCommentVNode(" point halo "),
                            point.halo.show
                              ? (Vue.openBlock(),
                                Vue.createElementBlock(
                                  "use",
                              ...
                              : Vue.createCommentVNode("v-if", true),
                            Vue.createCommentVNode(" point icon "),
                            point.icon.show
                              ? (Vue.openBlock(),
                                Vue.createElementBlock(
                                  "image",
                              ...
                              : Vue.createCommentVNode("v-if", true),
                            Vue.createCommentVNode(" point text "),
                            point.text.show
                              ? (Vue.openBlock(),
                                Vue.createElementBlock(
                                  "text",
                                  {
                                    key: 2,
                                    style: Vue.normalizeStyle(
                                      `fontSize:${point.text.fontSize}px;color:${point.text.color}`
                                    ),
                  ...
                  Vue.createCommentVNode(" flylines "),
                  (Vue.openBlock(true),
                  Vue.createElementBlock(
                    Vue.Fragment,
                    null,
                    Vue.renderList($data.flylines, (line, i) => {
                      return (
                        Vue.openBlock(),
                        Vue.createElementBlock(
                          "g",
                          ...
                          [
                            ...
                            Vue.createCommentVNode(" orbit line "),
                            Vue.createElementVNode(
                              "use",
                              {
                                "xlink:href": `#${line.key}`,
                            ...
                            Vue.createCommentVNode(" fly line gradient mask "),
                            Vue.createElementVNode(
                              "mask",
                              {
                            ...
                            Vue.createCommentVNode(" fly line "),
                            $data.flylineLengths[i]
                              ? (Vue.openBlock(),
                                Vue.createElementBlock(
                                  "use",
                                  {
          ...
          Vue.createElementBlock(
            ...
            [
              ...
              Vue.createElementBlock(
                Vue.Fragment,
                null,
                Vue.renderList($data.column, (item, i) => {
                  return (
                    Vue.openBlock(),
                    Vue.createElementBlock(
                      "g",
  ...
  function render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      Vue.createElementBlock(
        ...
        [
          $data.header.length && $data.mergedConfig
            ? (Vue.openBlock(),
              Vue.createElementBlock(
                "div",
                {
                ...
                [
                  ...
                  Vue.createElementBlock(
                    Vue.Fragment,
                    null,
                    Vue.renderList($data.header, (headerItem, i) => {
                      return (
                        Vue.openBlock(),
                        Vue.createElementBlock(
                          "div",
            ...
            ? (Vue.openBlock(),
              Vue.createElementBlock(
                "div",
                {
                  ...
                  class: "rows",
                  style: Vue.normalizeStyle(
                    `height: ${_ctx.height - ($data.header.length ? $data.mergedConfig.headerHeight : 0)}px;`
                  ),
                },
                [
                  (Vue.openBlock(true),
                  Vue.createElementBlock(
                    Vue.Fragment,
                    null,
                    Vue.renderList($data.rows, (row, ri) => {
                      return (
                        Vue.openBlock(),
                        Vue.createElementBlock(
                          "div",
        ...
        `),
                          ...
                          [
                            ...
                            Vue.createElementBlock(
                              Vue.Fragment,
                              null,
                              Vue.renderList(row.ceils, (ceil, ci) => {
                                return (
                                  Vue.openBlock(),
                                  Vue.createElementBlock(
                                    "div",
      ...
      Vue.createElementBlock(
        ...
        [
          ...
          Vue.createElementBlock(
            Vue.Fragment,
            null,
            Vue.renderList($data.rows, (item, i) => {
              return (
                Vue.openBlock(),
                Vue.createElementBlock(
                  "div",
                  ...
                  [
                    Vue.createElementVNode("div", _hoisted_1, [
                      Vue.createElementVNode(
                        "div",
                        _hoisted_2,
                        "No." + Vue.toDisplayString(item.ranking),
                        1 /* TEXT */
                      ),
                      Vue.createElementVNode(
                        "div",
                      ...
                      Vue.createElementVNode(
                        ...
                        _hoisted_4,
                        Vue.toDisplayString(
                          $data.mergedConfig.valueFormatter
                            ? $data.mergedConfig.valueFormatter(item)
                            : item.value + $data.mergedConfig.unit
                        ),
                        1 /* TEXT */
                      ),
                    ]),
